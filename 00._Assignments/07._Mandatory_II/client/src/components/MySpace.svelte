    ...
    <div class="text-center p-5 shadow-2xl grid bg-white text-black">
        <div>
            <h2 class="font-semibold text-2xl sm:text-3xl md:text-4xl">
                Whiteboard with <br /><span class="poppins text-violet-400">names history</span>
              </h2>
            ...
            {:else}
              <button type="button" on:click={clearHistory} class="mt-5 w-2/3 hover:bg-violet-400 font-bold p-3 rounded">
